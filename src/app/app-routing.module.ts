...
const routes: Routes = [
 ...
 // {path:"",component: WebDocumentsComponent},
  ...
  {path: "login",component: LoginComponent}, // route par de faut donc on fait appel a LoginComponent au demarrage de l application
  {path:"documents",component:WebDocumentsComponent},
  {path: "login",component: LoginComponent},
  {path: "categories",component: CategoriesComponent},
  {path: "sciencedirect",component: ArticlesComponent},
